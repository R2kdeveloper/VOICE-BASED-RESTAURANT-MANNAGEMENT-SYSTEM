...
def pay():
    def generate_qr_code():
        ...
        qr.add_data('1234567890')  # Replace this with the actual payment QR code data
        qr.make(fit=True)

        img = qr.make_image(fill_color="black", back_color="white")
        img.save('qr_code.png')

        qr_code_image = PhotoImage(file='qr_code.png')
    ...
    qr_code_label = Label(root2, text="QR Code will be displayed here", bg='white')
    qr_code_label.pack(pady=5)

    generateButton = Button(root2, text='GENERATE QR CODE', font=('arial', 16, 'bold'), bg='white', fg='blue', bd=7, relief=GROOVE, command=generate_qr_code)
...
buttonPay=Button(buttonFrame,text='Pay',font=('arial',14,'bold'),fg='white',bg='blue',bd=3,padx=5,command=pay)
buttonPay.grid(row=0,column=3)
...
button7=Button(calculatorFrame,text='7',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6,
               command=lambda:buttonClick('7'))
button7.grid(row=1,column=0)

button8=Button(calculatorFrame,text='8',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6,
               command=lambda:buttonClick('8'))
button8.grid(row=1,column=1)

button9=Button(calculatorFrame,text='9',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
               ,command=lambda:buttonClick('9'))
button9.grid(row=1,column=2)

buttonPlus=Button(calculatorFrame,text='+',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
                  ,command=lambda:buttonClick('+'))
buttonPlus.grid(row=1,column=3)

button4=Button(calculatorFrame,text='4',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
...
buttonMinus=Button(calculatorFrame,text='-',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
                   ,command=lambda:buttonClick('-'))
buttonMinus.grid(row=2,column=3)

button1=Button(calculatorFrame,text='1',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
...
buttonMult=Button(calculatorFrame,text='*',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
                  ,command=lambda:buttonClick('*'))
buttonMult.grid(row=3,column=3)

buttonAns=Button(calculatorFrame,text='Ans',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6,
                 command=answer)
buttonAns.grid(row=4,column=0)

buttonClear=Button(calculatorFrame,text='Clear',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
                   ,command=clear)
buttonClear.grid(row=4,column=1)

button0=Button(calculatorFrame,text='0',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6
               ,command=lambda:buttonClick('0'))
button0.grid(row=4,column=2)

buttonDiv=Button(calculatorFrame,text='/',font=('arial',16,'bold'),fg='yellow',bg='blue',bd=6,width=6,
                 command=lambda:buttonClick('/'))
